...
import { environment } from 'src/environments/environment'; // Use the correct prod or dev
...
export class PhotoEditorComponent implements OnInit {
  ...
  setMainPhoto(photo: Photo) {
    this.userService.setMainPhoto(this.authService.decodedToken.nameid, photo.id).subscribe(() => {
      this.alertifyService.success('Main photo update succesfully');
  ...
  deletePhoto(id: number) {
    this.alertifyService.confirm('Are you sure you wanna delete this photo ?', () => {
